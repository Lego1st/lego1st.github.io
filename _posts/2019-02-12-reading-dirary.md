...
[A Gentle Introduction to Calculating the BLEU Score for Text in Python](https://machinelearningmastery.com/calculate-bleu-score-for-text-python/) (blog?)

[Tìm Hiểu và Áp Dụng Cơ Chế Attention](https://pbcquoc.github.io/attention/)
